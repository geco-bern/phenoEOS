...
saveRDS(pep_check, "/cluster/home/lmarques/outputs_phenoEOS/pep_check_23S.rds")
...
saveRDS(df_pep_pmodel_Anet, "/cluster/home/lmarques/outputs_phenoEOS/pep_pmodel_Anet_23S.rds")
